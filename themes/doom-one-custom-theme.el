...
(defgroup doom-one-custom-theme nil
  "Options for the `doom-one-custom' theme."
  :group 'doom-themes)
...
(def-doom-theme doom-one-custom
  ...
  ((bg         '("#16161E" nil       nil            ))
   ...
   (modeline-bg              (if doom-one-custom-brighter-modeline
                                 (doom-darken blue 0.45)
                               (doom-darken bg-alt 0.1)))
   (modeline-bg-alt          (if doom-one-custom-brighter-modeline
  ...
  (((line-number &override) :foreground base4)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-one-custom-brighter-comments (doom-lighten bg 0.05)))
   (mode-line
   ...
   (mode-line-emphasis :foreground (if doom-one-custom-brighter-modeline base8 highlight))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if doom-one-custom-brighter-modeline modeline-bg highlight))
