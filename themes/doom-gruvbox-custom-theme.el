;; doom-gruvbox-custom-theme.el --- inspired by morhetz Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(defgroup doom-gruvbox-custom-theme nil
  "Options for doom-gruvbox-custom."
  :group 'doom-themes)

(defcustom doom-gruvbox-custom-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-gruvbox-custom-theme
  :type 'boolean)

(defcustom doom-gruvbox-custom-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-gruvbox-custom-theme
  :type '(choice integer boolean))

(defcustom doom-gruvbox-custom-dark-variant nil
...
;;
(def-doom-theme doom-gruvbox-custom
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-gruvbox-custom-dark-variant "hard") '("#1d2021" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-gruvbox-custom-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                        '("#202020" "#202020" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-gruvbox-custom-dark-variant "hard") '("#0d1011" "black" nil))     ; (self-defined)
          ((equal doom-gruvbox-custom-dark-variant "soft") '("#202020" "#202020" nil))   ; bg0
   ...
   ;; Standardized official colours from gruvbox-custom
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-gruvbox-custom-brighter-comments magenta grey))
   (doc-comments   (if doom-gruvbox-custom-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       red)
   (methods        green)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-gruvbox-custom-padded-modeline
      (if (integerp doom-gruvbox-custom-padded-modeline)
          doom-gruvbox-custom-padded-modeline
        4)))
   (modeline-bg bg-alt2)
...
;;; doom-gruvbox-custom-theme.el ends here
